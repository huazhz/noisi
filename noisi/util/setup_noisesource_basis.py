...
distribution_params = [
None,
{'center':(36.,131.),'sigma_radius_m':10000.,'only_ocean':True}
]
...
spectrum_types = ['gaussian','gaussian']
# parameters for gaussian: mean, standard deviation in Hz
spectrum_params = [{'mean':0.08,'std':0.05,'weight':1.},
                    {'mean':0.15,'std':0.02,'weight':5.}]
###############################################################################

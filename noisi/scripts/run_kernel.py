...
def g1g2_kern(wf1str,wf2str,kernel,adjt,
    ...
    print("Got config: "+str(time.time()-t0)+' sec')
    ...
    print("Got array lenghts: "+str(time.time()-t0)+' sec')
...
######################################################################## 
    ...
    print("Preparing source loop: "+str(time.time()-t0)+' sec')
    ...
    # Loop over locations
    ########################################################################            
    print("Starting source loop: "+str(time.time()-t0)+' sec')
